  ...
  return (
    <div className="min-h-screen brand-surface text-slate-100 selection:bg-brand-primary/30 font-sans">
      ...
      <section className="relative pt-32 pb-32 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,rgba(187,255,77,0.15),transparent_50%)]" />
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-black tracking-tight mb-8 leading-[1.1] text-transparent bg-clip-text bg-gradient-to-b from-white to-white/60">
      ...
      <section id="tech" className="py-24 bg-deep-forest/50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto brand-panel rounded-[32px] p-12 border border-white/5 shadow-[0_0_50px_rgba(255,255,255,0.02)]">
            <h2 className="text-3xl font-display font-black mb-8 text-center tracking-tight">Enterprise Infrastructure</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-brand-primary font-black text-2xl mb-1 font-display">React 19</div>
                <div className="text-[10px] text-white/30 uppercase tracking-widest font-bold">Frontend</div>
              </div>
              <div className="text-center">
                <div className="text-blue-400 font-black text-2xl mb-1 font-display">Firebase</div>
                <div className="text-[10px] text-white/30 uppercase tracking-widest font-bold">Backend & DB</div>
              </div>
              <div className="text-center">
                <div className="text-cyan-400 font-black text-2xl mb-1 font-display">Tailwind v4</div>
                <div className="text-[10px] text-white/30 uppercase tracking-widest font-bold">Architecture</div>
              </div>
              <div className="text-center">
                <div className="text-purple-400 font-black text-2xl mb-1 font-display">Vite</div>
      ...
      <section id="pricing" className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-display font-black mb-4 tracking-tighter">Transparent Licensing</h2>
            <p className="text-white/40">Equip your entire organization.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricing.map((p, i) => (
              ...
              >
                ...
                <div className="text-xl font-bold mb-2 pt-4 text-white/90">{p.name}</div>
      ...
      <section className="py-32 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <h2 className="text-5xl md:text-7xl font-display font-black mb-8 tracking-tighter">Ready to upgrade your operations?</h2>
          <p className="text-white/40 mb-12 max-w-xl mx-auto text-lg font-medium">
            Join the elite expedition leaders using Hillo technology to construct safer and more orchestrated experiences.
          </p>
          <Link 
            to="/" 
            className="inline-flex items-center gap-3 px-12 py-6 bg-brand-primary hover:bg-brand-soft text-night-ink rounded-[24px] font-black tracking-widest uppercase transition-all shadow-[0_0_30px_rgba(187,255,77,0.3)] hover:scale-105 active:scale-95"
          >
            Launch System
            <ArrowRight size={20} />
          </Link>
